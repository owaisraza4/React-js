...
<div textAlign="center" style={{padding:40}}>
      <h2>Contact Us</h2>
<FacebookRoundedIcon sx={{ fontSize: 40, padding:2 }}/>
<TwitterIcon sx={{ fontSize: 40 , padding:2 }}/>
<InstagramIcon sx={{ fontSize: 40 , padding:2 }}/>
<LinkedInIcon sx={{ fontSize: 40 , padding:2}}/>
